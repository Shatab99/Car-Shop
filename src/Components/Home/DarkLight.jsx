...
function DarkLight() {
    ...
    return (
        <div className={`DarkLight ${theme}`}>
            <button onClick={toggleTheme} className=' border-none hover:text-black  text-white rounded-full'>{theme === "dark" ?
